...
const int READER_CYCLE_TIMER_RATE = 2000; //XXX ms
////////
...
const int READER_NUM_CYCLES = 20;  //Number of Cycles, i.e. Power downs
const int READER_NUM_ROUNDS = 2;    //How many Queries per cycle. Only used if !CHANGE_Q. 
////////
...
const int NUM_TAGS = 1;       //The number of tags in the population
/////////
